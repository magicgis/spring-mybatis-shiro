...
<body>
	...
	<form
		...
		<table width="800" border="1" align="center" class="Tab">
			<div style="display: none;"> <form:input path="financialNewsPO.id" /> </div>
			<tr>
				<td>
					<div align="left">
						标题 :
			...
			<tr>
				<td>
					<div align="left">
						修改缩略图:<input name="imgFile" id="imgFile" type="file" />
						图片地址:<form:input path="financialNewsPO.thumbnail" readonly="true" size="50"/>
					</div>
				</td>
			</tr>
